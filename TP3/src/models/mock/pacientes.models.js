...
class PacientesModel {
  constructor() {
    this.data = []
    this.data.push(new Persona("123456787", "Sergio", "Antozzi", "email@gmail.com", "12345", 1))
    this.id = 2
  }
  ...
  validate(email, password) {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        console.log("palabra secreta, pacientes model:", Config.secretWord)

        const token = jwt.sign(payload, Config.secretWord, {
