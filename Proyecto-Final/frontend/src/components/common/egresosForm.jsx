...
const GastosForm = ({ onAgregar }) => {
  ...
  useEffect(() => {
    const fetchCategorias = async () => {
      try {
        ...
        setCategorias(response.data); // esto debe ser un array de objetos con id y nombre
      } catch (error) {
  ...
  // Formulario para cargar un nuevo gasto
  // Recibe una función onAgregar para agregar el nuevo gasto a la lista de gastos
  return (
