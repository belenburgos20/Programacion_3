...
export const registrarUsuario = (datos) => axios.post(`${API_URL}/crear-usuario`, datos) //datos del usuario al backend

export const iniciarSesion = (datos) => axios.post(`${API_URL}/login`, datos)
...
export const guardarEgreso = async (nuevoGasto) => {
  const response = await axios.post(`${API_URL}/movimientos`, nuevoGasto, {
    headers: {
      Authorization: `Bearer ${localStorage.getItem("token")}`,
    },
  })
...
export const actualizarMovimiento = (id, movimiento) =>
  axios.put(`${API_URL}/movimientos/editar/${id}`, movimiento, {
    headers: {
      Authorization: `Bearer ${localStorage.getItem("token")}`,
    },
  })

export const filtrarMovimientos = (filtros) => axios.post(`${API_URL}/movimientos/filtrar`, filtros)
...
export const obtenerResumen = () => axios.get(`${API_URL}/resumen`)
